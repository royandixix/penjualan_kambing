                            ...
                            <div class="modal-content rounded-4 shadow">
                                ...
                                <div class="modal-body">
                                    <form id="formBayar{{ $kambing->id }}"
                                        ...
                                        <!-- Kirim sebagai array sesuai backend -->
                                        <input type="hidden" name="items[{{ $kambing->id }}][id]" value="{{ $kambing->id }}">
                                        <input type="hidden" name="items[{{ $kambing->id }}][quantity]" value="1">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Toggle info pembayaran & upload bukti
            ...
            if (metode === 'qris') {
                html = `
                    <div class="text-center">
                        ...
                        <img src="/storage/qr/qrcode/qr_123.png" alt="QRIS" style="max-width: 250px;" class="img-fluid rounded shadow-sm">
    ...
    document.querySelectorAll('form[id^="formBayar"]').forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            if ((metode === 'qris' || metode === 'transfer') && fileInput && !fileInput.files.length) {
                e.preventDefault();
