                    ...
                    <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden position-relative">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-3 text-muted small">
                                <li><i class="bi bi-tags me-2"></i> Jenis: {{ $kambing->jenis_kambing ?? '-' }}</li>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content rounded-4 shadow">
                                    ...
                                    <div class="modal-body">
                                        <form id="formBayar{{ $kambing->id }}"
                                            action="{{ route('user.beli', $kambing->id) }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-3">
                                                <label class="form-label">Metode Pembayaran</label>
                                                <select class="form-select metode-select" name="metode_bayar"
                                                    data-id="{{ $kambing->id }}" required>
                                            ...
                                            <div class="info-metode mb-3" id="infoMetode{{ $kambing->id }}"
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('.metode-select').forEach(select => {
                select.addEventListener('change', function() {
                    ...
                    <div class="text-center">
                        ...
                        <img src="/storage/qr/qrcode/qr_123.png" alt="QRIS Dinamis" style="max-width: 250px;" class="img-fluid rounded shadow-sm">
                    ...
                    <div>
                        ...
                        <ul class="small">
                            ...
                            <li><strong>BRI</strong> - 170901004940508 a.n. Ternak Kamberu </li>
                        </ul>
                        ...
                        html =
                            `<p class="text-success">Pembayaran dilakukan saat kambing sampai ke rumah Anda.</p>`;
            ...
            document.querySelectorAll('form[id^="formBayar"]').forEach(form => {
                form.addEventListener('submit', function(e) {
                    ...
                    if ((metode === 'qris' || metode === 'transfer') && !form.querySelector(
                            'input[name="bukti_bayar"]').files.length) {
                        e.preventDefault();
