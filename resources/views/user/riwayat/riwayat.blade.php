...
<main>
    ...
    <div class="py-5 text-white" 
         style="background: linear-gradient(135deg, #198754, #28a745); border-radius: 0 0 20px 20px;">
        <div class="container">
    ...
    <div class="container my-4">
        @if($riwayat->isEmpty())
            <div class="text-center py-5">
                <img src="{{ asset('images/empty_cart.svg') }}" 
                     alt="Kosong" class="mb-3" style="max-width: 200px;">
                <h5 class="fw-bold text-muted">Belum ada riwayat pembelian</h5>
                <a href="{{ route('user.kambing') }}" class="btn btn-outline-success mt-2">
                    Belanja Sekarang
                </a>
            </div>
        @else
                ...
                <div class="card mb-4 shadow-sm border-0 rounded-4 overflow-hidden position-relative">
                    ...
                    <div class="card-body bg-white">
                        ...
                        <h5 class="fw-semibold mb-2 mt-2">
                            Pesanan pada 
                            <span class="text-success">{{ $pesanan->created_at->format('d M Y') }}</span>
                        </h5>
