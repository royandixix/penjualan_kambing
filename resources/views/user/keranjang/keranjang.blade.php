    ...
    <div class="container py-5">
        ...
        <div class="card border-0 rounded-4 shadow-sm mt-4">
            <div class="card-body bg-white d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-success btn-lg rounded-pill px-4" id="openModal" disabled
        ...
        <div class="modal fade" id="checkoutModal" tabindex="-1">
            <div class="modal-dialog">
                <form class="modal-content" action="{{ route('user.checkout.store') }}" method="POST" enctype="multipart/form-data" id="formCheckout">
                    @csrf
    ...
    function updateTotal() {
        ...
        checkboxes.forEach(cb => {
            ...
            if(cb.checked){
                ...
                wrapper.classList.add('dynamic-item-input');
                ...
                inputQty.name = `items[${id}][quantity]`;
                inputQty.value = qty;

                wrapper.appendChild(inputId);
                wrapper.appendChild(inputQty);
                formCheckout.appendChild(wrapper);
            }
        });
    ...
    metodeSelect.addEventListener('change', function(){
        ...
        if(metode === 'qris'){
            ...
            html = `<div>
                        ...
                        <ul class="small">
                            <li>BRI - 170901004940508 a.n. Ternak Kamberu</li>
                        </ul>
                    </div>`;
            uploadBukti.style.display = 'block';
        } else if(metode === 'cod'){
